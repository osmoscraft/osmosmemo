...
- Create a new [fine-grained access token](https://github.com/settings/personal-access-tokens/new) for the extension to add content on behalf of you. Make sure you select the correct repo and grant `Contents` permission with `Read and write` access.  
  ![image](https://github.com/user-attachments/assets/c80429dc-7e08-40c1-921a-cb264f27fde9)
